	...
	public static void main(String[] args) {
		...
		for (Employee employee : emparray) {
			try {
				...
				System.out.println(employee.getEmpName()+" "+e.getMessage());
			}
 
		}
	}
	
	void checkEmployeeSalary(Employee emp)throws EmpSalaryException {
		if(emp.getEmpSalary() < 1000) {
			throw new EmpSalaryException("EmpSalary Exception");
		}
	}
}
